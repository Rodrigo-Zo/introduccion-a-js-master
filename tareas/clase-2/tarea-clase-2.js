...
let operador = String(prompt('Ingrese el operador (+, -)'));
let numeroA = Number(prompt('Ingresa un numero'));
let numeroB = Number(prompt('Ingresa un numero'));
let resultado;
...
console.log(`El resultado de ${numeroA} ${operador} ${numeroB} es = ${resultado}`);
