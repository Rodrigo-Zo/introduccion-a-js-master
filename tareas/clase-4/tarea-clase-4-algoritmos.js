...
//Desafío de programación #4: Imprimí todas las tablas de multiplicación del 1 al 9
//1x0 = 0... 1x9 = 9 2x0 = 0...2x9 = 18......9x9 = 81
/*
let numero = 0;
let contador = 0;
for(let i = 1; i <= 10; i++){
...
//Desafío de programación #9: Crea una función que convierta de Fahrenheit a Celsius
/*
function convertirFahrenheitACelsius(n){
  return (n - 32) / 1.8;
}
console.log(convertirFahrenheitACelsius(132));
*/

//Desafío de programación #10: Calcula la suma de todos los números en un array de números
/*
let numeros = [100, 10, 20, 35, 44];
...
//Desafío de programación #11: Calcula el promedio de todos los números en un array de números. (en una función)
/*
let numeros = [10, 20, 3, 8, -100];

function calcularPromedioDeUnArray(n){
  let sumaResultado = 0;
  for (let i = 0 ; i < n.length; i++){
    sumaResultado += n[i];
  }

  return sumaResultado / n.length;
}

console.log(calcularPromedioDeUnArray(numeros));
*/
//Desafío de programación #12: Crea una función que reciba un array de números y devuelva un array conteniendo solo los números positivos
/*
function devolverArrayNumerosPositivos(array){
...
let numeros = [100, -11, -22, 55, 22, 0, 88];

console.log(devolverArrayNumerosPositivos(numeros));
*/
//Desafío de programación #13: Find the maximum number in an array of numbers
/*
...
let numeros = [100, 200, 533, -111, 55, 99];
