...
const AnioActual = Number(prompt('Ingresa el año actual'));
const fechaNacimientoUsuario = Number(prompt('Ingresa tu año de nacimiento'));

console.log(`Tienes ${calcularEdadUsuario(AnioActual, fechaNacimientoUsuario)} Años`);
*/
...
function calcularSalarioPorHora(salarioAnual){
    ...
    return salarioAnual / horasEnUnAño;
}


const salarioAnual = Number(prompt('Ingresa tu salario anual'));
