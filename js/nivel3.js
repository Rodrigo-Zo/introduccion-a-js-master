...
//A: 'Rodrigo Está editando aqui' en color AZUL.
//Website: Zokito.com en AMARILLO
/*
document.querySelector('h1').textContent = 'Rodrigo';
document.querySelector('h1').style.color = 'red';

document.querySelector('.textoSecundario').textContent = 'Rodrigo Está editando aqui';
document.querySelector('.textoSecundario').style.color = 'blue';


let paginaWeb = document.querySelector('.sitioweb');
paginaWeb.textContent = 'Rodrigo';
paginaWeb.style.color = 'Yellow';
paginaWeb.href = 'https://Zokito.com.org';

let sitioWeb = document.querySelector('.sitioweb2');
...
let titulo = document.querySelector('.twitter');


let nuevoNodo = document.createElement('div');
let nuevoParrafo = document.createTextNode('ROdrigo Aquiiiii');
