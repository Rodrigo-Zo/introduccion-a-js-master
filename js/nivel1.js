...
alert(nombreUsuario + edadUsuario);
*/
...
alert('El año actual es ' + AÑOACTUAL);
AÑOACTUAL = 2025;
alert('El año actual es ' + AÑOACTUAL);
*/
...
let diez = 10;
let tres = 3;
let resultadoMultipliacion = diez * tres;
...
if(operador === '+'){
    ...
    resultado = 'Introduce un operador correcto';
}
...
/*
let edadUsuario = 18;
let comprobarMayoriaEdad = (edadUsuario >= 18);
console.log(comprobarMayoriaEdad);
*/
////////////////////////////////////////////////////////////////////////////
