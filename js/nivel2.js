...
//let comidasFavoritas = ['milanesas', 'pizza', 'rabas'];
...
/*
let comidasFavoritas = ['milanesas', 'pizza', 'rabas'];
let tercerComidaFavorita = comidasFavoritas[2];
...
MASCOTAS.push('Lagarto');
console.log(MASCOTAS);
MASCOTAS[1] = 'Leon';
console.log(MASCOTAS);
MASCOTAS = ['Papas', 'Fideos'];
*/
...
/*
let comidasFavoritas = ['Pizza', 'Fideos', 'Milanesas'];
for(let i = 0; i<comidasFavoritas.length; i++){
    console.log(`Me gustan comidas como  ${comidasFavoritas[i]}`);
}
*/
/*
for (let i = 10; i >= 0; i--){
